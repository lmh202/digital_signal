...
# 特征权重数组（16个特征）
# 策略1：根据实测特征重要性调整（优化版v2 - 冲刺90%+准确率）
# 进一步强化最重要的3个特征，弱化低重要性特征
FEATURE_WEIGHTS = np.array([
    0.0,  # 0: main_frequency (重要性: 0.0184) - 降低权重
    0.054,  # 1: spectral_centroid (重要性: 0.0545)
    0.057,  # 2: spectral_bandwidth (重要性: 0.0568)
    0.090,  # 3: band_energy_0_2k (重要性: 0.0844) - 提升
    0.083,  # 4: band_energy_2k_5k (重要性: 0.0774)
    0.125,  # 5: band_energy_5k_10k (重要性: 0.1113) - 高，强化
    0.048,  # 6: band_energy_10k_15k (重要性: 0.0489)
    0.048,  # 7: band_energy_15k_25.6k (重要性: 0.0485)
    0.0,  # 8: peak_freq_1 (未在前10) - 降低
    0.130,  # 9: peak_freq_2 (重要性: 0.1155) - 很高，强化
    0.180,  # 10: peak_freq_3 (重要性: 0.1575) - 最高！最大化权重
    0.038,  # 11: peak_freq_4 (重要性: 0.0400)
    0.0,  # 12: peak_freq_5 (重要性: 0.0292) - 降低
    0.100,  # 13: rms (重要性: 0.0918) - 高，提升
    0.055,  # 14: peak_amplitude (重要性: 0.0548)
    0.025,  # 15: zero_crossing_rate (重要性: 0.0292) - 降低
])  # 总和 = 1.093
